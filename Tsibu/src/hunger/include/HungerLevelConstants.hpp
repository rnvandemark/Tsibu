...
#define HUNGER_LEVEL_FSM_NAME "hunger_level"
...
#define HUNGER_LEVEL_VARIABLE_LAST_STATE_INCREMENT "last_state_change"
#define HUNGER_LEVEL_VARIABLE_CUMULATIVE_SATIATION "cumulative_satiation"
